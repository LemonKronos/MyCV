...
\textbullet Experienced in collaborative environments using Git; proficient in reading, understanding, and safely contributing to shared codebases.\\
...
\begin{twmnotebook}[\dimexpr \textwidth-2pt\relax]{Education.log}[0pt]
    ...
    \cvrow{{[Passion Project]}}{\textcolor{chillblue}{Developed a ROS2 + PX4 drone simulation pipeline in Gazebo to support acrobatic trajectory imitation learning}\hyperlink{drone}{\textcolor{link}{**}}}
\end{twmnotebook}
...
\textbullet \quad Dream to be a Robotic engineer\\
