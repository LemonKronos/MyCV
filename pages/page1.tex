...
\begin{twmnotebook}[\dimexpr \textwidth-2pt\relax]{Education.log}[0pt]
    ...
    \cvrow{{[Passion Project]}}{\textcolor{chillblue}{DDeveloped a ROS2 + PX4 drone simulation pipeline in Gazebo for acrobatic flight imitation learning.}\hyperlink{drone}{\textcolor{link}{**}}}
\end{twmnotebook}
