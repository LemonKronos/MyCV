...
\textbullet Experienced in collaborative environments using Git; proficiency in reading, understanding, and safely contributing to shared codebases.\\
\textbullet Wish to transition into a full-time engineering role after the internship.
\end{twmnotebook}%
\twmgap
...
\begin{twmnotebook}[\dimexpr \textwidth-2pt\relax]{Education.log}[0pt]
    ...
    \cvrow{{[current GPA]}}{2.5/4.0 \hyperlink{GPA}{\textcolor{link}{*}}} %# what to put here, that like a log say this is not all there is
    ...
    \cvrow{{[Passion Project]}}{\textcolor{chillblue}{Built a ROS2 + PX4 drone simulation pipeline in Gazebo for acrobatic trajectory imitation learning}\hyperlink{drone}{\textcolor{link}{**}}}
\end{twmnotebook}
...
\textbullet \quad Dream to be a Robotic engineer, working on drone\\
\textbullet \quad "I need a money, I must find jobs, pls"\\
\textbullet \quad Open-source mind set, a part of Linux community\\
\textbullet \quad Hopefully my project could make up for my GPA
\end{twmnotebook}